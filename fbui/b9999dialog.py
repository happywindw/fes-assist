...
class B9999Dialog(wx.Dialog):
    ...
    def __init__(self, parent):
        wx.Dialog.__init__(self, parent, id=wx.ID_ANY, title=u"B9999下载过渡户交易明细", pos=wx.DefaultPosition,
        ...
        self.bank_text = wx.StaticText(self, wx.ID_ANY, u"选择银行：", wx.DefaultPosition, wx.DefaultSize, 0)
        self.bank_text.Wrap(-1)
        bank_sizer.Add(self.bank_text, 0, wx.ALIGN_CENTER | wx.ALL, 5)

        bank_choiceChoices = [u"工商银行", u"建设银行"]
        ...
        self.sd_text = wx.StaticText(self, wx.ID_ANY, u"开始日期：", wx.DefaultPosition, wx.DefaultSize, 0)
        self.sd_text.Wrap(-1)
        ...
        self.ed_text = wx.StaticText(self, wx.ID_ANY, u"结束日期：", wx.DefaultPosition, wx.DefaultSize, 0)
        self.ed_text.Wrap(-1)
